...
import com.fingerprint.security.research.clipboard.clipboard_history_screen.ClipboardHistoryActivity
...
class WelcomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startButton.setOnClickListener { openScreen(ClipboardHistoryActivity::class.java) }
